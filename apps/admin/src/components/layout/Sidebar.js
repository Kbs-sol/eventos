...
export function Sidebar({ isOpen, onClose }) {
    ...
    return (_jsxs("aside", { className: `
      ...
      `, children: [_jsxs("div", { className: "h-16 flex items-center gap-3 px-5 border-b border-white/10 flex-shrink-0", children: [_jsx("div", { className: "w-8 h-8 rounded-lg bg-indigo-600 flex items-center justify-center text-white text-sm font-bold", children: "E" }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsx("p", { className: "text-sm font-semibold text-white truncate", children: config.company.name }), _jsx("p", { className: "text-[10px] text-gray-500 uppercase tracking-wider", children: "Admin Panel" })] }), _jsx("button", { onClick: onClose, className: "lg:hidden p-1 text-gray-500 hover:text-white", children: _jsx("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M6 18L18 6M6 6l12 12" }) }) })] }), _jsx("nav", { className: "flex-1 overflow-y-auto py-4 px-3 space-y-6", children: navItems.map((group) => (_jsxs("div", { children: [_jsx("p", { className: "px-3 mb-2 text-[10px] font-semibold text-gray-500 uppercase tracking-wider", children: group.group }), _jsx("div", { className: "space-y-0.5", children: group.items.map((item) => {
                                const active = isActive(item.href);
                                return (_jsxs(Link, { to: item.href, onClick: onClose, className: `
                      flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium
                      transition-all duration-150 group
                      ${active
                                        ? 'bg-indigo-600/20 text-indigo-400'
                                        : 'text-gray-400 hover:text-white hover:bg-white/5'}
                    `, children: [_jsx("svg", { className: `w-5 h-5 flex-shrink-0 ${active ? 'text-indigo-400' : 'text-gray-500 group-hover:text-gray-300'}`, fill: "none", stroke: "currentColor", strokeWidth: 1.5, viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: item.icon }) }), item.label, active && (_jsx("span", { className: "ml-auto w-1.5 h-1.5 rounded-full bg-indigo-400" }))] }, item.href));
                            }) })] }, group.group))) }), _jsx("div", { className: "p-4 border-t border-white/10", children: _jsxs("a", { href: "/", target: "_blank", rel: "noopener noreferrer", className: "flex items-center gap-2 px-3 py-2 rounded-lg text-xs text-gray-500 hover:text-gray-300 hover:bg-white/5 transition-colors", children: [_jsx("svg", { className: "w-4 h-4", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" }) }), "View Live Site"] }) })] }));
}
